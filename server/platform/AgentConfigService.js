...
const ADMIN_DEFAULTS = {
  ...
  'doc-extractor': {
    enabled:             true,
    model:               null,
    max_tokens:          16384, // complex multi-field documents can otherwise truncate JSON
  ...
  'ads-copy-diagnostic': {
    enabled:             true,
    model:               null,
    max_tokens:          8192,          // 5-section narrative report across multiple ad groups
  ...
  'keyword-opportunity': {
    enabled:             true,
    model:               null,
    max_tokens:          8192,          // 4-section report; keyword table up to 150 rows needs headroom
